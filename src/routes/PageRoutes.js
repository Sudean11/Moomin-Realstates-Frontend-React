...
import PropertiesTable from "../components/dashboard/owner/PropertiesTable.jsx";
...
import CustomerOffers from "../components/dashboard/client/CustomerOffer.jsx";
const PageRoutes = () => {
  return (
    <>
      <Routes>
        ...
        <Route path="/owner-dashboard" element={<OwnerPanelLayout/>}>
          ...
          <Route path="propertyList" element={<PropertiesTable/>} />
